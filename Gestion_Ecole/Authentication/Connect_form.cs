...
namespace Gestion_Ecole
{
    public partial class Connect_form : MetroForm
    {
        ...
        //Properties
        //
        readonly Gestion_Ecole  db      = new Gestion_Ecole();
        readonly Helper_class   helper  = new Helper_class();
        ...
        {
            var user = db.Authentication.Where(a => a.Username == username.Text && a.Password == password.Text).Select(a => new { a.First_Name, a.Last_Name, a.Type }).ToList();
            if (user.Count > 0)
            {
